...
/**
 *Fragment that shows the guide of AED/CPR accessed via Navigation Drawer in
...
class GuideFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        arrayList.add(
            Detail("3","Remove clothing and attach pads correctly\n" +
                "\n" +
        ...
        arrayList.add(
            Detail("5","Prepare to let the AED analyze the heart’s rhythm\n" +
                "\n" +
                "1. Make sure no one is touching the person\n" +
                "2. Say, “CLEAR!” in a loud, commanding voice\n")
        )
        arrayList.add(
            Detail("6","Deliver a shock, if the AED determines one is needed\n" +
                "\n" +
                "1. Make sure no one is touching the person\n" +
                "2. Say, “CLEAR!” in a loud, commanding voice\n" +
